...
const SkillUpdate = () => {
  ...
  const { id } = useParams();
  const skill = useSelector(selectSkillDetail);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        title: "Updated!",
        text: "Your Skill is updated successfully!",
        icon: "success",
        timer: 1500,
      });
      ...
      Swal.fire({
        title: "Failed",
        text: "Your Skill is updated failed!",
        icon: "error",
        timer: 1500,
      });
      console.log(error);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Fill in the form to update a new skill.
          </p>
        </div>
